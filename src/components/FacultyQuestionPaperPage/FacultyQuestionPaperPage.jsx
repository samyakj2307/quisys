    ...
    if (history.location.state === "New") {
      axios
        ...
        .then(function (response) {
          ...
          if (
            response.status === 200 &&
            response.data.status === "Added class Successfully"
          ) {
      ...
      axios
        ...
        .then(function (response) {
          ...
          if (
            response.status === 200 &&
            response.data === "Successfully Updated Exam Details"
          ) {
            history.push("/FacultyHomePage");
          }
        })
    ...
    <div className={"mainQuestionContainer"}>
      <Row className={"examDetails"}>
        <Col style={{ textAlign: "center" }} md={2}>
          <img
            className={"quisysLogo quisysLogo2"}
            src={quisysLogo}
            alt={"quisys-logo"}
          />
        </Col>
      ...
      <Row className={"examDetails"}>
        <Col
          ...
          className={"ExamHeading InputLabel"}
        >
          Exam Name
          <input
      ...
      <Row>
        <Col style={{ textAlign: "center" }}>
          ...
          >
            <img src={plusSign} alt={"Add Question"} />
          </button>
        </Col>
      </Row>
      <Row>
        <Col style={{ textAlign: "center" }}>
          <button className={"saveQuestionPaper"} onClick={saveQuestionPaper}>
            Save
          </button>
        </Col>
      </Row>
