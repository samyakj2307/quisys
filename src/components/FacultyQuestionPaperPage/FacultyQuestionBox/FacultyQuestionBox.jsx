...
function FacultyQuestionBox(props) {
  ...
  function renderTextBox() {
    return <TextBox key={props.index} index={props.index} />;
  }

  function renderOptions() {
    return (
      <div>
        <OptionBox key={props.index} index={props.index} />
        <br />
      </div>
    );
  }
  ...
  return (
    <Container className={"mainContainerQuestionBox"}>
      <Row>
        <Col>
          <button onClick={deleteQuestion} className={"deleteQuestion"}>
        ...
        <Col className={"radioButtonContainer"}>
          ...
          >
            <FormControlLabel
              ...
              label={
                <Typography style={styles.formControlLabel}>Choice</Typography>
              }
            />
            <FormControlLabel
              className={"typeOfAnswers"}
              ...
              control={<StyledRadioButton />}
              label={
                <Typography style={styles.formControlLabel}>Text</Typography>
              }
            />
          </RadioGroup>
        </Col>
